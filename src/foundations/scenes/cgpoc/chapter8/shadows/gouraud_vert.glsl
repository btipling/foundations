...
void main()
{
    ...
    fo_light_1_z_pos_0 = f_scene_data.light_1_views[0] * f_P;
    fo_light_1_y_neg_1 = f_scene_data.light_1_views[1] * f_P;
    fo_light_1_z_neg_2 = f_scene_data.light_1_views[2] * f_P;
    fo_light_1_y_pos_3 = f_scene_data.light_1_views[3] * f_P;
    fo_light_1_x_pos_4 = f_scene_data.light_1_views[4] * f_P;
    fo_light_1_x_neg_5 = f_scene_data.light_1_views[5] * f_P;

    fo_light_2_z_pos_0 = f_scene_data.light_2_views[0] * f_P;
    fo_light_2_y_neg_1 = f_scene_data.light_2_views[1] * f_P;
    fo_light_2_z_neg_2 = f_scene_data.light_2_views[2] * f_P;
    fo_light_2_y_pos_3 = f_scene_data.light_2_views[3] * f_P;
    fo_light_2_x_pos_4 = f_scene_data.light_2_views[4] * f_P;
    fo_light_2_x_neg_5 = f_scene_data.light_2_views[5] * f_P;
}
